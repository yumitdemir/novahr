...
class JobOpeningPolicy
{
    ...
    {
        return $user->can('force_delete_job::opening');
    }
    ...
    {
        return $user->can('force_delete_any_job::opening');
    }
    ...
    {
        return $user->can('restore_job::opening');
    }
    ...
    {
        return $user->can('restore_any_job::opening');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, JobOpening $jobOpening): bool
    {
        return $user->can('replicate_job::opening');
    }
    ...
    {
        return $user->can('reorder_job::opening');
    }
}
